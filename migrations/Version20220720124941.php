 ...
 */
final class Version20220720124941 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE fk_company_id company_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `user` CHANGE company_id fk_company_id INT DEFAULT NULL');
